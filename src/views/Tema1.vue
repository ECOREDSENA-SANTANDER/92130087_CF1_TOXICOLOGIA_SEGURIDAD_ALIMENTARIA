...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.mb-5.t1
      ...
      .col-sm-6.col-lg-4.mb-4.mb-lg-0
        .tarjeta--boton.color-secundario.p-4.h-100
          ...
          h4.bgtitulo3.mb-4.py-1.px-3.text-center Estudios toxicocinéticos
      ...
      .col-sm-6.col-lg-4.mb-4.mb-lg-0
        .tarjeta--boton.color-secundario.p-4.h-100
          ...
          h4.bgtitulo3.mb-4.py-1.px-3.text-center Estudios de toxicidad a corto, medio y largo plazo
    ...
    .tarjeta.bgc-slider.p-4.p-lg-5.mb-5(data-aos="fade-down")
      SlyderA.tarjeta.tarjeta--blanca.p-4(tipo="b")
    ...
    TabsC.color-acento-contenido.mb-5
      .bg4.p-4.py-md-5(titulo="Tóxicos endógenos")
        .row.justify-content-center
          .col-md-6.col-lg-5.mb-3.mb-md-0
      ...
      .bg4.p-4.py-md-5(titulo="Tóxicos exógenos")
        .row.justify-content-center
          .col-md-6.col-lg-5.mb-3.mb-md-0
      ...
      SlyderA.tarjeta.tarjeta--blanca.p-4.pt-5(tipo="b")
        .row.justify-content-center.align-items-center
          .col-lg-11.mb-4.mb-md-0
            h4 Antivitaminas
            p Son compuestos mayormente de naturaleza proteica que actúan sobre algunas vitaminas disminuyendo o destruyendo su función biológica, induciendo el aumento de las exigencias de las vitaminas. Entre las más importantes se encuentran la avidina, la tiaminasa, la niacitina y el ácido ascórbico oxidasa.
            img(src='@/assets/curso/temas/t1/slid1.png', alt='')
        .row.justify-content-center.align-items-center
          .col-lg-11.mb-4.mb-md-0
            h4 Avidina
            p Se encuentra en la clara de huevo y es capaz de bloquear la absorción de la biotina (vitamina H o vitamina B8), por formación de un precipitado insoluble, afectando a su biodisponibilidad. La avidina es una glicoproteína que se combina con dos moléculas de biotina inhibiendo su absorción. Se inactiva por ebullición en agua en pocos minutos. El consumo excesivo de huevo de gallina crudo produce síntomas de falta de biotina con dermatitis exfoliativa y conjuntivitis.
            img(src='@/assets/curso/temas/t1/slid2.png', alt='')
        .row.justify-content-center.align-items-center
          .col-lg-11.mb-4.mb-md-0
            h4 Tiaminasa
        ...
        .row.justify-content-center.align-items-center
          ...
          .col-lg-5
            ...
            .tarjeta.bg7.p-4.py-lg-5.mb-4
              ul.lista-ul--color.fa-ul.color-secundario.mb-0
                li.mb-0
                  i.fas.fa-check-circle
                  span.mb-0 #[b Efecto antioxidante:] inhibe la oxidación de lípidos y la acumulación de peróxidos en los alimentos.
            .tarjeta.bg7.p-4.py-lg-5.mb-4
              ul.lista-ul--color.fa-ul.color-secundario.mb-0
                li.mb-0
                  i.fas.fa-check-circle
                  span.mb-0 #[b Disminuye la glucemia:] se une a las amilasas intestinales disminuyendo la liberación de azúcares simples.
    ...
    .bgtitulo2.mb-4.px-4.py-1(data-aos="fade-right")
      h3.mb-0 Sustancias de actividad polivalente

    p A estas sustancias se les asignan propiedades antinutritivas sobre nutrientes de distinta naturaleza: proteínas, minerales y vitaminas. Existen dos grandes grupos: las fibras y los taninos.
